    ...
    return (
        <>
            <Container>
                ...
                <p>Welcome to Addmeon!</p>

                <p>These terms and conditions outline the rules and regulations for the use of Vicando GmbH's Website,
                    located at https://admeon.org.</p>

                <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                    Addmeon if you do not agree to take all of the terms and conditions stated on this page.</p>
                ...
                <p>We employ the use of cookies. By accessing Addmeon, you agreed to use cookies in agreement with the
                    Vicando GmbH's Privacy Policy. </p>
                ...
                <p>Unless otherwise stated, Vicando GmbH and/or its licensors own the intellectual property rights for
                    all material on Addmeon. All intellectual property rights are reserved. You may access this from
                    Addmeon for your own personal use subjected to restrictions set in these terms and conditions.</p>

                <p>You must not:</p>
                <ul>
                    <li>Republish material from Addmeon</li>
                    <li>Sell, rent or sub-license material from Addmeon</li>
                    <li>Reproduce, duplicate or copy material from Addmeon</li>
                    <li>Redistribute content from Addmeon</li>
                </ul>
                ...
                <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                    certain areas of the website. Vicando GmbH does not filter, edit, publish or review Comments prior
                    to their presence on the website. Comments do not reflect the views and opinions of Vicando GmbH,its
                    agents and/or affiliates. Comments reflect the views and opinions of the person who post their views
                    and opinions. To the extent permitted by applicable laws, Vicando GmbH shall not be liable for the
                ...
                <p>Vicando GmbH reserves the right to monitor all Comments and to remove any Comments which can be
                ...
                <p>You hereby grant Vicando GmbH a non-exclusive license to use, reproduce, edit and authorize others to
                ...
                <p>We will approve link requests from these organizations if we decide that: (a) the link would not make
                    ...
                    the absence of Vicando GmbH; and (d) the link is in the context of general resource information.</p>
                ...
                <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                    website, you must inform us by sending an e-mail to Vicando GmbH. Please include your name, your
                ...
                <p>No use of Vicando GmbH's logo or other artwork will be allowed for linking absent a trademark license
                    agreement.</p>
